...
# Config MySQL
app.config['MYSQL_HOST'] = environ.get('localhost')
app.config['MYSQL_USER'] = environ.get('root')
app.config['MYSQL_PASSWORD'] = environ.get('tosin')
app.config['MYSQL_DB'] = environ.get('pydb')
